  ...
  switch ($_GET[act]) {
    ...
    case "tambahpenyakit":
      echo "<form name=text_form method=POST action='$aksi?module=penyakit&act=input' onsubmit='return Blank_TextField_Validator()' enctype='multipart/form-data'>
          <br><br><table class='table table-bordered'>
		  <tr><td width=120>Nama Kerusakan</td><td><input autocomplete='off' type=text placeholder='Masukkan kerusakn baru...' class='form-control' name='nama_penyakit' size=30></td></tr>
		  <tr><td width=120>Detail Kerusakan</td><td> <textarea rows='4' cols='50' class='form-control' name='det_penyakit'type=text placeholder='Masukkan detail kerusakn baru...'></textarea></td></tr>
		  <tr><td width=120>Saran Kerusakan</td><td><textarea rows='4' cols='50' class='form-control' name='srn_penyakit'type=text placeholder='Masukkan saran kerusakn baru...'></textarea></td></tr>
