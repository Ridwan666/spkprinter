...
<html><head>
    ...
    <base href="http://localhost/spkprinter/">
  ...
  <body id="" class="hold-transition skin-purple-light sidebar-mini">
    <div class="wrapper">
      <!-- Main Header -->
      <header class="main-header">
        ...
        <a href="" class="logo">
          ...
          <span class="logo-mini"><b><i class="" aria-hidden="true"></i>Pt</b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b><i class="" aria-hidden="true"></i>Printer 1.0</b></span>
        </a>
        <!-- Header Navbar -->
                ...
                if (isset($_SESSION['username']) && isset($_SESSION['password'])) {
                  ...
                  <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                      <img src="" class="user-image" alt="User Image"> <?php echo ucfirst($_SESSION['username']); ?>
                      ...
                      <li class="user-header">
                        ...
                        <p>
                         Login sebagai <?php echo ucfirst($_SESSION['username']); ?>
                          <small>Pakar dari Printer 1.0</small>
                        </p>
                      </li>
                      <!-- Menu Body -->
                      <li class="user-body">
...
function kirimContactForm(){
    ...
    if(nama.trim() == '' ){
        ...
        <strong><div class="cinta">Copyright © 2022 - Made with <i class="fa fa-heart pulse"></i> by <a href="" target="_blank">Kelompok Satu Sistem Pakar</a></div></strong>
      </footer>
